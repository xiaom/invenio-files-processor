...
project = u'Invenio-Files-Processor'
...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-files-processor@GitHub': 'https://github.com/inveniosoftware/invenio-files-processor',
        'invenio-files-processor@PyPI': 'https://pypi.python.org/pypi/invenio-files-processor/',
    }
}
...
htmlhelp_basename = 'invenio-files-processor_namedoc'
